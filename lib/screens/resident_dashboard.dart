              ...
              child: Column(
                ...
                children: [
                  ...
                  if (adminProvider.announcements.isNotEmpty) ...[
                    Card(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          adminProvider.announcements.first['title'] ??
                              'Announcement',
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        subtitle: Text(
                          adminProvider.announcements.first['message'] ?? '',
                          maxLines: 2,
                  ...
                  GridView.count(
                    ...
                    children: [
                      _buildActionCard(
                        ...
                        color: AppTheme.primaryBlue,
                        onTap: () =>
                            Navigator.pushNamed(context, '/report_concern'),
                      ),
                      _buildActionCard(
                        context,
                        title: 'My Reports',
                      ...
                      _buildActionCard(
                        ...
                        onTap: () =>
                            Navigator.pushNamed(context, '/emergency_sos'),
                      ),
                      _buildActionCard(
                        context,
                        title: 'Announcements',
                  ...
                  if (provider.isLoading && provider.myReports.isEmpty)
                    ...
                    ...provider.myReports.take(3).toList().asMap().entries.map((
                      entry,
                    ) {
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: TextButton.icon(
                          ...
                          onPressed: () =>
                              Navigator.pushNamed(context, '/admin_queue'),
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          if (report['report_evidence'] != null &&
              report['report_evidence'].isNotEmpty)
            Padding(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final storagePath =
                        report['report_evidence'][index]['storage_path'];
                    final url = Provider.of<ReportProvider>(
                      context,
                      listen: false,
                    ).getEvidenceUrl(storagePath);
                    return Container(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    report['admin_resolution_notes'] ?? 'No notes provided.',
                  ),
